...
if(dojo.isIE||dojo.isSafari){
dojo._ieDispatcher=function(_56,_57){
var ap=Array.prototype,h=dojo._ie_listener.handlers,c=_56.callee,ls=c[dojo._ieListenersName],t=h[c.target];
var r=t&&t.apply(_57,_56);
var lls=[].concat(ls);
for(var i in lls){
if(!(i in ap)){
h[lls[i]].apply(_57,_56);
}
}
return r;
};
