...
if(!dojo._hasResource["dojox.editor.plugins.FontChoice"]){
...
dojo.declare("dojox.editor.plugins.FontChoice",dojox.editor._Plugin,{_uniqueId:0,buttonClass:dijit.form.FilteringSelect,useDefaultCommand:false,_initButton:function(){
var _1=this.command;
