...
if(!dojo._hasResource["dojox.editor.plugins.EnterKeyHandling"]){
dojo._hasResource["dojox.editor.plugins.EnterKeyHandling"]=true;
dojo.provide("dojox.editor.plugins.EnterKeyHandling");
dojo.declare("dojox.editor.plugins.EnterKeyHandling",dojox.editor._Plugin,{blockNodeForEnter:"BR",constructor:function(_1){
if(_1){
dojo.mixin(this,_1);
}
...
var _9=dojo.withGlobal(this.editor.window,"getAncestorElement",dojox.editor.selection,["LI"]);
if(!_9){
dojox.editor.RichText.prototype.execCommand.call(this.editor,"formatblock",this.blockNodeForEnter);
var _a=dojo.withGlobal(this.editor.window,"getAncestorElement",dojox.editor.selection,[this.blockNodeForEnter]);
if(_a){
...
var _15=dojo.withGlobal(this.editor.window,"getParentElement",dojox.editor.selection);
...
dojox.editor.RichText.prototype.execCommand.call(this.editor,"formatblock",this.blockNodeForEnter);
_18={blockNode:dojo.withGlobal(this.editor.window,"getAncestorElement",dojox.editor.selection,[this.blockNodeForEnter]),blockContainer:this.editor.editNode};
if(_18.blockNode){
...
var _1c=/P|DIV|LI/i.test(_1b.tagName)?_1b:dojox.editor.selection.getParentOfType(_1b,["P","DIV","LI"]);
if(!_1c){
return;
}
if(_1c.lastChild){
