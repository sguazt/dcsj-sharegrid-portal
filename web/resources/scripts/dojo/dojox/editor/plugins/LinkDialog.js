...
if(!dojo._hasResource["dojox.editor.plugins.LinkDialog"]){
...
_a=dojo.withGlobal(this.editor.window,dojox.editor.selection.getSelectedText);
}
this.dropDown.reset();
