...
if(!dojo._hasResource["dojox.editor.plugins.AlwaysShowToolbar"]){
dojo._hasResource["dojox.editor.plugins.AlwaysShowToolbar"]=true;
dojo.provide("dojox.editor.plugins.AlwaysShowToolbar");
dojo.declare("dojox.editor.plugins.AlwaysShowToolbar",dojox.editor._Plugin,{_handleScroll:true,setEditor:function(e){
if(!e.iframe){
