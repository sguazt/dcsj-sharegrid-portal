...
if(!dojo._hasResource["dojox.editor.RichText"]){
...
dojox.editor.RichTextIframeMixin={_writeOpen:function(_3){
if(dojo.isIE||dojo.isSafari||dojo.isOpera){
if(dojo.config["useXDomain"]&&!dojo.config["dojoBlankHtmlUrl"]){
console.warn("dojox.editor.RichText: When using cross-domain Dojo builds,"+" please save dojo/resources/blank.html to your domain and set djConfig.dojoBlankHtmlUrl"+" to the path on your domain to blank.html");
}
...
dojox.editor.RichText.prototype._setDisabledAttr.call(this,_22);
},blur:function(){
this.window.blur();
}};
dojo.declare("dojox.editor.RichText",dijit._Widget,{constructor:function(_23){
...
while(_2e){
dojox.editor.selection.selectElement(_2e.firstChild);
dojo.withGlobal(this.window,"selectElement",dojox.editor.selection,[_2e.firstChild]);
...
_32=this._preFilterContent(dojox.editor.getChildrenHtml(dn));
dn.innerHTML="";
}
if(_32==""){
_32="&nbsp;";
...
dojo.withGlobal(this.window,_73,dojox.editor.selection,_74);
...
return dojox.editor.getNodeHtml(_8b);
