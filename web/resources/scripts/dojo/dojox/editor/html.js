...
if(!dojo._hasResource["dojox.editor.html"]){
dojo._hasResource["dojox.editor.html"]=true;
dojo.provide("dojox.editor.html");
dojox.editor.escapeXml=function(_1,_2){
...
dojox.editor.getNodeHtml=function(_3){
var _4;
switch(_3.nodeType){
case 1:
...
var j=0;
while((_b=_5[j++])){
_4+=" "+_b[0]+"=\""+(dojo.isString(_b[1])?dojox.editor.escapeXml(_b[1],true):_b[1])+"\"";
}
if(_3.childNodes.length){
_4+=">"+dojox.editor.getChildrenHtml(_3)+"</"+_3.nodeName.toLowerCase()+">";
}else{
_4+=" />";
}
break;
case 3:
_4=dojox.editor.escapeXml(_3.nodeValue,true);
break;
case 8:
_4="<!--"+dojox.editor.escapeXml(_3.nodeValue,true)+"-->";
break;
...
dojox.editor.getChildrenHtml=function(dom){
var out="";
if(!dom){
return out;
}
...
var _15,i=0;
while((_15=_14[i++])){
out+=dojox.editor.getNodeHtml(_15);
}
return out;
};
}
