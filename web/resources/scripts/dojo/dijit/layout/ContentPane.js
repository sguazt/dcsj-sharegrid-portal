...
try{
_14.onDownloadEnd.call(_14);
_14._isDownloaded=true;
_14.attr.call(_14,"content",_17);
}
catch(err){
_14._onError.call(_14,"Content",err);
}
delete _14._xhrDfd;
return _17;
});
...
if(!_16.cancelled){
_14._onError.call(_14,"Download",err);
}
delete _14._xhrDfd;
return err;
});
...
if(!(_1a&&_1a instanceof dojo.html._ContentSetter)){
_1a=this._contentSetter=new dojo.html._ContentSetter({node:this.containerNode,_onError:dojo.hitch(this,this._onError),onContentError:dojo.hitch(this,function(e){
var _1c=this.onContentError(e);
try{
this.containerNode.innerHTML=_1c;
}
catch(e){
...
var _1d=dojo.mixin({cleanContent:this.cleanContent,extractContent:this.extractContent,parseContent:this.parseOnLoad},this._contentSetterParams||{});
dojo.mixin(_1a,_1d);
_1a.set((dojo.isObject(_19)&&_19.domNode)?_19.domNode:_19);
delete this._contentSetterParams;
},_onError:function(_1e,err,_20){
var _21=this["on"+_1e+"Error"].call(this,err);
if(_20){
console.error(_20,err);
}else{
if(_21){
this._setContent.call(this,_21);
}
}
...
},onContentError:function(_24){
},onDownloadError:function(_25){
