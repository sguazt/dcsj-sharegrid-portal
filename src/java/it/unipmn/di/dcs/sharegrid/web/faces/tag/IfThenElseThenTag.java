...
/**
 * Tag for specifying the 'then' part of 'if-then-else' conditions at runtime.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public class IfThenElseThenTag extends UIComponentELTag
{
	/** A constructor. */
	public IfThenElseThenTag()
	{
		super();
	}
	...
	{
		return FacesConstants.IfThenElseThenComponentType;
	}

	@Override
	public String getRendererType()
	{
		return FacesConstants.IfThenElseThenRendererType;
	}
